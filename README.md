...
`Cuphead/BepInEx/plugins/Coophead/`, inicia el juego y busca `Co-ophead 0.7.0
cargado` en `BepInEx/LogOutput.log`.

### Remote Input Lab

La versión `0.7.0` puede crear y controlar localmente a Player Two sin un segundo
